...
def get_params():
    global N, M
    with grpc.insecure_channel(others_ip_addr + ':50052') as channel:
...
def valid_position_getter(available_pos):
    with grpc.insecure_channel(others_ip_addr + ':50051') as channel:
...
rpc_list = [(Create_Soldier(), own_ip_addr + ':40051', rpc1.add_Create_SoldierServicer_to_server), (Missile_Approaching(), own_ip_addr + ':40052', rpc2.add_Missile_ApproachingServicer_to_server),(All_Taken_Shelter(),own_ip_addr + ':40053',rpc3.add_All_Taken_ShelterServicer_to_server), (Status(),own_ip_addr + ':40054', rpc4.add_StatusServicer_to_server), (Send_Commander_Index(),own_ip_addr + ':40055', rpc5.add_Send_Commander_IndexServicer_to_server), (Game_Over(),own_ip_addr + ':40056', rpc6.add_Game_OverServicer_to_server)]
